    ...
    <div className={"home"}>
      ...
      <section className="hero">
        <div className="announce">
          ...
          <p>Introducing Roomiful 2.0</p>
        </div>

        <h1>Build awesome spaces with a speed of thought with Roomiful</h1>

        <p className="subtitle">
          Roomiful is an AI-first design environment that helps you visualize,
